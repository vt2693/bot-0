...
class BrowserTool:
    ...
    def get_openai_tools(self) -> list[dict]:
        if not self._ready:
            return []
        return [{"type": "function", "function": {"name": "browse_web", "description": "Navigate to a URL and perform a web task.", "parameters": {"type": "object", "properties": {"task": {"type": "string"}, "url": {"type": "string"}}, "required": ["task"]}}}]
