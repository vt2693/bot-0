...
Cohesion: 0.16
Nodes (6): _action_schedule_list(), _action_schedule_pause_by_id(), _action_schedule_remove_by_id(), _action_schedule_resume_by_id(), Route callback_query: navigation (mn:*) or action (ac:*)., TelegramBot

### Community 7 - "Telegram Bot Lifecycle & Queue"
Cohesion: 0.29
Nodes (5): _action_model_switch(), _action_tts_model_switch(), Switch TTS model for this chat. Persists to memory_store., Enqueue an editMessageText to the outbox., Send or edit a menu message. Edits existing menu if one was sent before.
