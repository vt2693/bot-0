...
tmux new-session -d -s hermes -n relay "while true; do python relay.py 2>&1 | tee -a logs/relay.log; echo 'Relay crashed, restarting in 2s...'; sleep 2; done"
tmux new-window -t hermes -n voice "while true; do python voice_relay.py 2>&1 | tee -a logs/voice.log; echo 'Voice relay crashed, restarting in 2s...'; sleep 2; done"
